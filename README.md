...
Before submitting your project, ensure you have completed the following steps. Please note that the submission can only be accepted if these minimum requirements are met.
